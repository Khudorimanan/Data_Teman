...
class MainActivity: AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //mendapatkan Firebase Authentikasi
...
//Mendapatkan UserID dari pengguna yang Terautentikasi
                ...
                if (isEmpty(getNama) || isEmpty(getAlamat) || isEmpty(getNoHP)) {
                    ...
                    //3ika Ado, maka akan menampilkan pesan singkat seperti berikut ini
                    Toast.makeText(this@MainActivity, "Data tidak boleh ada yang kosong",
                        Toast.LENGTH_SHORT).show()

                    //Jiko Tidok ada, moko menyimpan ke database sesuai 10 masing-masing akun
                } else {
